...
var MjCarousel = /*#__PURE__*/function (_BodyComponent) {
  ...
  function MjCarousel() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "componentHeadStyle", function () {
      ...
      if (!length) return '';
      var carouselCss = "\n    .mj-carousel {\n      -webkit-user-select: none;\n      -moz-user-select: none;\n      user-select: none;\n    }\n\n    .mj-carousel-".concat(_this.carouselId, "-icons-cell {\n      display: table-cell !important;\n      width: ").concat(_this.getAttribute('icon-width'), " !important;\n    }\n\n    .mj-carousel-radio,\n    .mj-carousel-next,\n    .mj-carousel-previous {\n      display: none !important;\n    }\n\n    .mj-carousel-thumbnail,\n    .mj-carousel-next,\n    .mj-carousel-previous {\n      touch-action: manipulation;\n    }\n\n    ").concat((0, _range2["default"])(0, length).map(function (i) {
        return ".mj-carousel-".concat(carouselId, "-radio:checked ").concat((0, _repeat2["default"])('+ * ', i), "+ .mj-carousel-content .mj-carousel-image");
      }).join(','), " {\n      display: none !important;\n    }\n\n    ").concat((0, _range2["default"])(0, length).map(function (i) {
        return ".mj-carousel-".concat(carouselId, "-radio-").concat(i + 1, ":checked ").concat((0, _repeat2["default"])('+ * ', length - i - 1), "+ .mj-carousel-content .mj-carousel-image-").concat(i + 1);
      }).join(','), " {\n      display: block !important;\n    }\n\n    .mj-carousel-previous-icons,\n    .mj-carousel-next-icons,\n    ").concat((0, _range2["default"])(0, length).map(function (i) {
        return ".mj-carousel-".concat(carouselId, "-radio-").concat(i + 1, ":checked ").concat((0, _repeat2["default"])('+ * ', length - i - 1), "+ .mj-carousel-content .mj-carousel-next-").concat((i + 1 % length + length) % length + 1);
      }), ",\n    ").concat((0, _range2["default"])(0, length).map(function (i) {
        return ".mj-carousel-".concat(carouselId, "-radio-").concat(i + 1, ":checked ").concat((0, _repeat2["default"])('+ * ', length - i - 1), "+ .mj-carousel-content .mj-carousel-previous-").concat((i - 1 % length + length) % length + 1);
      }), " {\n      display: block !important;\n    }\n\n    ").concat((0, _range2["default"])(0, length).map(function (i) {
        return ".mj-carousel-".concat(carouselId, "-radio-").concat(i + 1, ":checked ").concat((0, _repeat2["default"])('+ * ', length - i - 1), "+ .mj-carousel-content .mj-carousel-").concat(carouselId, "-thumbnail-").concat(i + 1);
      }).join(','), " {\n      border-color: ").concat(_this.getAttribute('tb-selected-border-color'), " !important;\n    }\n\n    .mj-carousel-image img + div,\n    .mj-carousel-thumbnail img + div {\n      display: none !important;\n    }\n\n    ").concat((0, _range2["default"])(0, length).map(function (i) {
        return ".mj-carousel-".concat(carouselId, "-thumbnail:hover ").concat((0, _repeat2["default"])('+ * ', length - i - 1), "+ .mj-carousel-main .mj-carousel-image");
      }).join(','), " {\n      display: none !important;\n    }\n\n    .mj-carousel-thumbnail:hover {\n      border-color: ").concat(_this.getAttribute('tb-hover-border-color'), " !important;\n    }\n\n    ").concat((0, _range2["default"])(0, length).map(function (i) {
        return ".mj-carousel-".concat(carouselId, "-thumbnail-").concat(i + 1, ":hover ").concat((0, _repeat2["default"])('+ * ', length - i - 1), "+ .mj-carousel-main .mj-carousel-image-").concat(i + 1);
      }).join(','), " {\n      display: block !important;\n    }\n    ");
      var fallback = "\n      .mj-carousel noinput { display:block !important; }\n      .mj-carousel noinput .mj-carousel-image-1 { display: block !important;  }\n      .mj-carousel noinput .mj-carousel-arrows,\n      .mj-carousel noinput .mj-carousel-thumbnails { display: none !important; }\n\n      [owa] .mj-carousel-thumbnail { display: none !important; }\n\n      @media screen yahoo {\n          .mj-carousel-".concat(_this.carouselId, "-icons-cell,\n          .mj-carousel-previous-icons,\n          .mj-carousel-next-icons {\n              display: none !important;\n          }\n\n          .mj-carousel-").concat(carouselId, "-radio-1:checked ").concat((0, _repeat2["default"])('+ *', length - 1), "+ .mj-carousel-content .mj-carousel-").concat(carouselId, "-thumbnail-1 {\n              border-color: transparent;\n          }\n      }\n    ");
  ...
  (0, _createClass2["default"])(MjCarousel, [{
    ...
    value: function thumbnailsWidth() {
      ...
      return this.getAttribute('tb-width') || "".concat((0, _min2["default"])([this.context.parentWidth / this.props.children.length, 110]), "px");
    }
  }, {
    ...
    value: function generateControls(direction, icon) {
      ...
      return "\n      <td\n        ".concat(this.htmlAttributes({
        ...
        style: 'controls.div'
      }), "\n        >\n          ").concat((0, _range2["default"])(1, this.props.children.length + 1).map(function (i) {
