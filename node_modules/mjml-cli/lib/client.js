      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          pickArgs = function pickArgs(args) {
            return (0, _flow2["default"])((0, _pick2["default"])(args), (0, _pickBy2["default"])(function (e) {
              return (0, _negate2["default"])(_isNil2["default"])(e) && !((0, _isArray2["default"])(e) && (0, _isEmpty2["default"])(e));
            }));
          };
          ...
          inputFiles = (0, _isArray2["default"])(inputArgs[inputOpt]) ? inputArgs[inputOpt] : [inputArgs[inputOpt]];
          inputs = [];
        ...
        case 26:
          (0, _watchFiles["default"])(inputFiles, (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, argv), {}, {
            config: config
          }));
          KEEP_OPEN = true;
          return _context.abrupt("break", 36);
        ...
        case 36:
          ...
          inputs.forEach(function (i) {
            try {
              ...
              switch (inputOpt) {
                ...
                default:
                  compiled = (0, _mjmlCore["default"])(i.mjml, (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, config), {}, {
                    filePath: filePath || i.file,
                    actualPath: i.file
                  }));
              }

              convertedStream.push((0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, i), {}, {
                compiled: compiled
              }));
            } catch (e) {
              EXIT_CODE = 2;
          ...
          isInvalid = failedStream.length || convertedStream.some(function (s) {
            return !!(0, _get2["default"])(s, 'compiled.errors.length');
          });
