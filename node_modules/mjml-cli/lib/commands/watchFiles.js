...
var _flatMap = _flatMap3["default"].convert({
  cap: false
...
var flatMapKeyAndValues = (0, _flow2["default"])(_flatMap(function (v, k) {
...
var _default = function _default(input, options) {
  ...
  var getRelatedFiles = function getRelatedFiles(file) {
    return (0, _flow2["default"])((0, _pickBy2["default"])(function (v, k) {
  ...
  var readAndCompile = (0, _flow2["default"])(function (file) {
    return {
      file: file,
  ...
  var watcher = _chokidar["default"].watch(input.map(function (i) {
    ...
    (0, _remove2["default"])(dirty, function (f) {
      return f === filePath;
    });
    synchronyzeWatcher(filePath);
  });
