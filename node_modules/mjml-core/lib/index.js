...
function mjml2html(mjml) {
  ...
  var _mjmlConfigOptions$op = (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, mjmlConfigOptions), options),
  ...
  var mjBody = (0, _find2["default"])(mjml.children, {
    tagName: 'mj-body'
  });
  var mjHead = (0, _find2["default"])(mjml.children, {
    tagName: 'mj-head'
  });

  var _processing = function processing(node, context) {
    var parseMJML = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _identity2["default"];
  ...
  var applyAttributes = function applyAttributes(mjml) {
    var parse = function parse(mjml) {
      ...
      var classes = (0, _get2["default"])(mjml.attributes, 'mj-class', '').split(' ');
      var attributesClasses = (0, _reduce2["default"])(classes, function (acc, value) {
      ...
      var defaultAttributesForClasses = (0, _reduce2["default"])(parentMjClass.split(' '), function (acc, value) {
        return (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, acc), (0, _get2["default"])(globalDatas.classesDefault, "".concat(value, ".").concat(tagName)));
      }, {});
      var nextParentMjClass = (0, _get2["default"])(attributes, 'mj-class', parentMjClass);
      return (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, mjml), {}, {
        ...
        children: (0, _map2["default"])(children, function (mjml) {
  ...
  if (globalDatas.inlineStyle.length > 0) {
    if (juicePreserveTags) {
      (0, _each2["default"])(juicePreserveTags, function (val, key) {
