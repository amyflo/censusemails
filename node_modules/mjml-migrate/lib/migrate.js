...
function cleanAttributes(attributes) {
  (0, _keys2["default"])(attributes).forEach(function (key) {
...
function migrateSocialSyntax(socialTag) {
  ...
  (0, _keys2["default"])(networks).forEach(function (network) {
...
function migrateHeroSyntax(heroTag) {
  var child = (0, _find2["default"])(heroTag.children, {
    tagName: 'mj-hero-content'
  });
  return (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, heroTag), {}, {
    children: child.children,
    attributes: (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, heroTag.attributes), child.attributes)
  });
}
...
function loopThrough(tree) {
  (0, _keys2["default"])(tree).forEach(function (key) {
    if (key === 'children') {
