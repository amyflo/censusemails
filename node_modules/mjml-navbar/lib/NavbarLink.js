...
var MjNavbarLink = /*#__PURE__*/function (_BodyComponent) {
  ...
  (0, _createClass2["default"])(MjNavbarLink, [{
    ...
    value: function renderContent() {
      ...
      var link = navbarBaseUrl ? "".concat(navbarBaseUrl).concat(href) : href;
      var cssClass = this.getAttribute('css-class') ? " ".concat(this.getAttribute('css-class')) : '';
      return "\n      <a\n        ".concat(this.htmlAttributes({
        "class": "mj-link".concat(cssClass),
        href: link,
