...
(0, _each2["default"])(defaultSocialNetworks, function (val, key) {
  defaultSocialNetworks["".concat(key, "-noshare")] = (0, _objectSpread3["default"])((0, _objectSpread3["default"])({}, val), {}, {
    'share-url': '[[URL]]'
  });
});
...
var MjSocialElement = /*#__PURE__*/function (_BodyComponent) {
  ...
  (0, _createClass2["default"])(MjSocialElement, [{
    ...
    value: function getSocialAttributes() {
      ...
      var attrs = ['icon-size', 'icon-height', 'srcset', 'sizes', 'src', 'background-color'].reduce(function (r, attr) {
        return (0, _objectSpread3["default"])((0, _objectSpread3["default"])({}, r), {}, (0, _defineProperty2["default"])({}, attr, _this.getAttribute(attr) || socialNetwork[attr]));
      }, {});
    ...
    value: function render() {
      var _this$getSocialAttrib2 = this.getSocialAttributes(),
          ...
          srcset = _this$getSocialAttrib2.srcset,
          sizes = _this$getSocialAttrib2.sizes,
