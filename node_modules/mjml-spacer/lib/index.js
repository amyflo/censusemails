...
var MjSpacer = /*#__PURE__*/function (_BodyComponent) {
  ...
  (0, _createClass2["default"])(MjSpacer, [{
    ...
    value: function render() {
      ...
      return "\n      ".concat((0, _conditionalTag["default"])("\n        <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td height=\"".concat(parseInt(height, 10), "\" style=\"height:").concat(height, ";\">\n      ")), "\n      <div\n        ").concat(this.htmlAttributes({
        style: 'div'
      }), "\n      >\n        &nbsp;\n      </div>\n      ").concat((0, _conditionalTag["default"])("\n        </td></tr></table>\n      "), "\n    ");
    }
  }]);
